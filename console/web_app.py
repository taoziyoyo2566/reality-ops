...
from . import config, db, publish as pub, queries, registry as reg
...
def create_app(settings, start_watcher=True, csrf_secret=None):
    ...
    def home(request: Request):
        with db.connect(settings.db_path) as conn:
            ...
            return page(request, "home.html",
                        ...
                        last_publish=db.last_publish(conn))
